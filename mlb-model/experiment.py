...
#
# Experiment 135: park_weight = -0.9 — continue downward trend from -0.6.
# Hypothesis: -0.6 kept; direction still active; try -0.9 with holdout guard.
...
park_weight    = -0.9   # park factor deviation — EXP 135: try -0.9 (was -0.6)
