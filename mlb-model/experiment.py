...
#
# Experiment 77: gap_weight = -0.37 (was -0.35).
# Hypothesis: fine-tune abs SP FIP gap weight upward; -0.33 lost, try -0.37 on the other side.
...
gap_weight     = -0.37  # abs SP FIP gap — EXP 77: try -0.37 (was -0.35)
intercept      = 0.00
