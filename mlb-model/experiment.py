...
#
# Experiment 54: gap_weight fine-tune to -0.20 (was -0.18 after EXP 53 kept).
# Hypothesis: -0.18 still improved; test -0.20 to find plateau or overfit point.
...
gap_weight     = -0.20  # abs SP FIP gap — EXP 54: try -0.20 (was -0.18)
intercept      = 0.00
