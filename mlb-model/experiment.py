...
#
# Experiment 46: park_weight fine-tune to 1.8 (was 2.0).
# Hypothesis: pulling back park weight may reduce noise from minor park differences
# and let the pitcher/offense signals dominate more cleanly.
...
park_weight    = 1.8    # park factor deviation — EXP 46: try 1.8 (was 2.0)
