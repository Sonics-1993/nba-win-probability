...
#
# Experiment 136: park_weight = -1.2 — continue downward trend from -0.9.
# Hypothesis: -0.9 kept; direction still active; try -1.2.
...
park_weight    = -1.2   # park factor deviation — EXP 136: try -1.2 (was -0.9)
