...
#
# Experiment 122: park_weight = 1.6 (was 1.8).
# Hypothesis: 1.8 neutral — push lower to 1.6 to test if linear term can be reduced further.
...
park_weight    = 1.6    # park factor deviation — EXP 122: try 1.6 (was 1.8)
