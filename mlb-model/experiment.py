...
#
# Experiment 61: model_blend fine-tune to 0.37 (was 0.38 after EXP 60 kept).
# Hypothesis: 0.38 improved both splits; test if 0.37 continues improving.
...
intercept      = 0.00
model_blend    = 0.37   # EXP 61: try 0.37 (was 0.38)
