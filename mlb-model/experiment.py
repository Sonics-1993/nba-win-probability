...
#
# Experiment 95: park2_weight = 3.0 (was 2.5).
# Hypothesis: 2.5 kept with holdout still improving; try 3.0 to find the top.
...
park2_weight   = 3.0    # EXP 95: park factor quadratic term — try 3.0 (was 2.5)
intercept      = 0.00
