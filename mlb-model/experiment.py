...
#
# Experiment 13: Re-tune model_blend from 0.40 to 0.45.
# Hypothesis: the statistical model has slightly more signal than currently weighted.
# Try increasing model contribution to 0.45 (less market reliance).
# Test: model_blend = 0.45 (was 0.40).
...
intercept      = 0.00
model_blend    = 0.45   # EXPERIMENT 13: try 0.45 (was 0.40) — more model weight
