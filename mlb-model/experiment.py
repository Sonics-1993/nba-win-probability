...
#
# Experiment 137: park_weight = -1.5 — continue downward trend from -1.2.
# Hypothesis: -1.2 kept; direction still active; try -1.5.
...
park_weight    = -1.5   # park factor deviation — EXP 137: try -1.5 (was -1.2)
